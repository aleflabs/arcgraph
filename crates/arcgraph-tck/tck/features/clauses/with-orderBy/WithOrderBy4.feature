...
# which are otherwise lost after the WITH clause according to Cypher semantics
  ...
  Scenario: [2] Sort by an alias for a projected expression
    Given an empty graph
    And having executed:
      """
      CREATE (:A {num: 1, num2: 4}), //num + num2 = 5
  ...
  Scenario: [4] Sort by one projected expression and one alias for a projected expression with order priority being different than projection order
    Given an empty graph
    And having executed:
      """
      CREATE (:A {num: 1, num2: 4}), //num2 % 3 = 1, num + num2 = 5
  ...
  Scenario: [5] Sort by one alias for a projected expression and one projected expression with order priority being different than projection order
    Given an empty graph
    And having executed:
      """
      CREATE (:A {num: 1, num2: 4}), //num2 % 3 = 1, num + num2 = 5
  ...
  Scenario: [7] Sort by an alias for a projected expression where the alias shadows an existing variable
    Given an empty graph
    And having executed:
      """
      CREATE (:A {num: 1, num2: 4}), //num2 % 3 = 1, num + num2 = 5
  ...
  Scenario: [9] Sort by an alias for a projected expression containing the variable shadowed by the alias
    Given an empty graph
    And having executed:
      """
      CREATE (:A {num: 1, num2: 4}), //num2 % 3 = 1, num + num2 = 5
  ...
  Scenario: [10] Sort by a non-projected expression containing an alias for a projected expression containing the variable shadowed by the alias
    Given an empty graph
    And having executed:
      """
      CREATE (:A {num: 1, num2: 4}), //num2 % 3 = 1, num + num2 = 5
